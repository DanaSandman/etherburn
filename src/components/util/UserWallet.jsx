...
import {
  ...
  setWalletNotify,
  setWalletOnboard,
} from "../../store/wallet/wallet.action.js";
...
export default function UserWallet() {
  ...
  return (
    <div>
      {!account && (
        <button className="login connect-btn" onClick={onLogin}>
          Connect
        </button>
      )}
      {account && (
        <div className="connected">
          <button className="logout connect-btn" onClick={onLogout}>
